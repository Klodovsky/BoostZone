    ...
    t && t.addEventListener && (t.Slim = function() {
                ...
                var i = ["input", "change"],
                    n = function() {
                        ...
                        return p(n, [{
                            ...
                            value: function() {
                                var t = this;
                                this._element.className = "slim-image-editor", this._container = k("div", "slim-container"), this._wrapper = k("div", "slim-wrapper"), this._stage = k("div", "slim-stage"), this._container.appendChild(this._stage), this._cropper = new _t, i.forEach(function(e) {
            ...
            vt = function() {
                ...
                return function() {
                    ...
                    return p(n, [{
                        ...
                        set: function(t) {
                            if (this._element.className == "slim-file-hopper") return;
        ...
        return function() {
            ...
            St.concat(gt.Buttons).concat("rotate").forEach(function(t) {
                ...
                var e, i, n, o = [];
                for (e = t.querySelectorAll(".slim:not([data-state])"), n = e.length; n--;) i = e[n], o.push(Lt.create(i, Lt.getOptionsFromAttributes(i)));
                return o
